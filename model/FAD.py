...
class FAD_Head(nn.Module):
    def __init__(self, size):
        ...
        # self.filters = nn.ModuleList([low_filter, middle_filter])
        self.filters = low_filter
    ...
    def forward(self, x):
        ...
        x_pass = self.filters(x_freq)  # [N, 3, 299, 299]
        out = self._DCT_all_T @ x_pass @ self._DCT_all  # [N, 3, 299, 299]
